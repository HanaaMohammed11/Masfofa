    ...
    >
      <thead dir={direction}>
        <tr dir={direction} className="bg-[#D3A17A] text-white">
          <th className="px-2 md:px-4 py-2">{t("addaccount.firstName")}</th>
          <th className="px-2 md:px-4 py-2">{t("addaccount.email")}</th>
          <th className="px-2 md:px-4 py-2">{t("addaccount.password")}</th>
        ...
        {filteredEmployees.length > 0 ? (
          filteredEmployees.map((employee) => (
            ...
            >
              ...
              <td className="px-2 md:px-4 py-2">{employee.accountType}</td>
